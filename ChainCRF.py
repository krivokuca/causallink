"""
Authored by https://github.com/phipleg/keras/blob/crf/keras/layers/crf.py
"""
...
def _forward(x, reduce_step, initial_states, U, mask=None):
    """
    Forward recurrence step of the linear chain constant-rate factor (CRF)

    Returns:
        - last (numpy.ndarray) :: The last layer with shape [X[0], U[n]]
        - values (numpy.ndarray) :: The forward feed values with shape [n, ]
    """
